...
function getPopupStyling() {
  ...
  return [
    ...
    ".between{position:absolute;z-index:-1;overflow:hidden;width:0px;height:0px;background: transparent}",
    ".between.active{height:100%;width:100%;z-index:9;background:rgba(0, 0, 0, 0.1);opacity:0.7;transition:opacity 0.4s ease-in 0s;}",
