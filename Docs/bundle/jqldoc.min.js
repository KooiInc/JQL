...
`).replace(/</g,"&lt;").replace(/\$/g,"&dollar;").trim()}}function c(d){let u=d.target.scrollTop,g=e.nodes(".paragraph, [data-groupcontainer]").find(i=>u-i.nextElementSibling.offsetTop<=-120);if(g){let i=e(`[data-navitem="#${g.querySelector("h3").id}"]`);i.hasClass("selected")||(e(".navGroup:not(.closed)").addClass("closed"),i.closest(".navGroup").removeClass("closed"),e(".selected").removeClass("selected"),i.addClass("selected"))}}}function O(e){let n=Symbol.jqlvirtual,m=Symbol.jql,c=Symbol.jql2Root,d=o=>`<code class="inline">${o}</code>`,u=o=>o===void 0?"Yep \u{1F60E}":"Nope \u{1F621}",g=(o,t=0)=>([o,t]=[Math.floor(o),Math.ceil(t)],Math.floor([...crypto.getRandomValues(new Uint32Array(1))].shift()/2**32*(o-t+1)+t)),i=e.Popup,b=e.node(".docs"),y=()=>b.scrollBy(0,-15),R=()=>{let o=e.button({id:"modalCloseDemo"},"Close me")[n].on("click",()=>i.removeModal()),t=()=>i.show({content:"Modal closed, you're ok, bye.",closeAfter:2}),s=e.virtual(e("[data-popup2]").HTML.get()).append(e.virtual("<p/>").append(o));i.show({content:s,modal:!0,callback:t,warnMessage:'"In other words: <i>you can only close this using the <b>button</b> ...</i>"'})},f=(...o)=>setTimeout(()=>{e('#tmpEx, [data-id="tmpEx"]').remove(),o.length>0&&e.removeCssRule(...o)},1500),C=(o=!1)=>o?e.removeCssRule("#tmpEx"):e.editCssRule("#tmpEx {color: green; font-weight: bold;}");e.log("Documenter handling done.");let p=o=>o.target.closest(".description");return{popupTimedEx:()=>{i.createTimed("Hi, this is a popup! I'll be active for 5 seconds (as long as you don't close me first).",5,()=>i.createTimed("I am closing",2))},popupCreateModalEx:()=>{let o="        Hi. This box is <i>really</i> modal.        <br>There is no close icon and clicking outside this box does nothing.        <br>In other words: you can only close this using the button below.        <br>Try clicking anywhere outside the box ...",t=e.button({id:"modalCloseTest"},"Close me");e.delegate("click","#modalCloseTest",i.removeModal);let s=()=>i.show({content:"Modal closed, you're ok, bye.",closeAfter:2}),l=e.div(o,e.div({style:"margin-top: 0.6rem;"},t)).outerHTML;e.Popup.create(l,!0,s,"There's only one escape here!")},popupShowModalEx:()=>{let o="        Hi. This box is <i>really</i> modal.        <br>There is no close icon and clicking outside this box does nothing.        <br>In other words: you can only close this using the button below.        <br>Try clicking anywhere outside the box ...",t=e.button({id:"modalCloseTest"},"Close me");e.delegate("click","#modalCloseTest",i.removeModal);let s=()=>i.show({content:"Modal closed, you're ok, bye.",closeAfter:2}),l=e.div(o,e.div({style:"margin-top: 0.6rem;"},t)).outerHTML;e.Popup.show({content:l,modal:!0,callback:s,warnMessage:"You <i>can</i> read, can't you?"})},popupCreateEx:()=>{i.create(e.div("Here's a popup message for you.",e.div("Close it by clicking the checkmark icon or anywhere outside the box")))},popupShowEx:()=>{i.show({content:e.div("Here's a popup message for you.",e.div("Close it by clicking the checkmark icon or anywhere outside the box"))})},popupShowTimedEx:()=>{i.show({content:e.div("Here's a popup message for you.",e.div("Close it by clicking the checkmark icon or anywhere outside the box"),e.div("If you don't, I will close all by myself after 5 seconds ;)")),closeAfter:5})},addClassEx:o=>{e.editCssRule("#tmpEx.warnUser {color: red; font-weight: bold;}"),e.editCssRule(".user:before {content: 'Hi user! ';}"),e('<div id="tmpEx">This is not very useful</div>',p(o)).addClass("warnUser","user"),e("#tmpEx").remove()},appendEx:o=>{C(),e.editCssRule(".appended { color: red; cursor: pointer; }");let t=e.virtual('<div class="appended">I am an appended JQL instance ...</div>').on("click",()=>alert("HELLO!")),s=e('<div id="tmpEx">Hi there! Wait a sec ... </div>',p(o)).append(t,"Appended text","<div>Appended HTML string</div>",Object.assign(document.createElement("div"),{textContent:"Appended element"}));setTimeout(()=>i.show({content:t.html("Now I am appended to the popup element, you can still click me"),callback:()=>e("#tmpEx").remove()}),1500)},prependEx:o=>{e("#tmpEx").remove(),C(),e.editCssRule(".appended { color: red; }"),e('<div id="tmpEx">... hi there!</div>',p(o)).prepend('<div class="appended">Hello and also ...</div>'),setTimeout(e("#tmpEx").remove,2e3)},afterMeEx:o=>{e.Popup.show({content:e.div("I am div 1")[n].afterMe(e("<div>And I am div 2</div>"))})},beforeMeEx:o=>{e.Popup.show({content:e("<div>...and I am div 2</div>").andThen(e.div("...and finally I am div 4")[n].beforeMe(e.div("...hithere, I am div 3")[n])).beforeMe(e(e.div("I am div 1")))})},andThenEx:o=>{let t=e.p("I am the first"),s=e.p("I am the second"),l='<code class="inline">ele1[create].andThen(ele2)</code>',r='<code class="inline">ele2[create].andThen(ele1)</code>',v='<code class="inline">ele2[create].andThen(ele1, true)</code>';e.Popup.show({content:e(l).andThen(t).andThen(s[n]),closeAfter:3.5,callback:()=>e.Popup.show({closeAfter:3.5,content:e(r).andThen(s).andThen(t),callback:()=>e.Popup.show({content:s[n].andThen(t,!0).andThen(v),closeAfter:3.5})})})},isEx:o=>{let t=x=>`<code class="inline">${x}</code>`,s=e.input({id:"disabledInput",disabled:!0,type:"text",placeholder:"I am not enabled"})[n],{is:l}=s,r=()=>`<ul>${[...Object.keys(l)].reduce((x,E)=>x.concat(`<li>${t(E)}? ${l[E]}</li>`),"")}
        ...
        <br><code class="inline">exElem.prop("onclick")</code> =&gt; ${t.prop("onclick")}`,closeAfter:4}),setTimeout(()=>t.remove(),1e4)},removeClassEx:o=>{e.editCssRule(".exTest { color: red; font-weight: bold; }");let t=e('<div data-id="tmpEx"><b>Hello</b> <span class="exTest">World</span>!</div>',p(o));setTimeout(()=>{t.find$("span").removeClass("exTest"),setTimeout(()=>t.remove(),2500)},1500)},getDataEx:o=>{let t=e(o.target),s=t.getData("action"),l=t.getData("nonexistent"),r=t.getData("nothing","NOCANDO");i.show({content:[`<code class="inline">action</code>: "${s}"`,`<code class="inline">undef</code>: ${l}`,`<code class="inline">undefWithDefaultValue</code>: "${r}"`].join("<br>")})},editCssRuleEx:o=>{e.editCssRule("#div1 {margin: 0.3rem; color: green; background-color: #EEE; }"),e.editCssRule("#div2",{margin:"0.3rem",color:"red",backgroundColor:"#EEE"});let t=e.virtual('<div id="div1">I am div#div1</div>'),s=e.virtual('<div id="div2">I am div#div2</div>');i.show({content:e(e.div()).append(t,s),callback:()=>e.removeCssRules("#div1","#div2")})},editCssRulesEx:()=>{let o=e.virtual("<div id='div1'>I am div#div1</div>"),t=e.virtual("<div id='div2'>I am div#div2</div>");e.editCssRules("#div1 { margin: 0.3rem; color: green; background-color: #EEE; }","#div2 { margin: 0.3rem; color: red; background-color: #EEE; }"),i.show({content:e("<div>").append(o,t),callback:()=>e.removeCssRules("#div1","#div2")})},removeCssRulesEx:()=>{let o=e.virtual("<div id='div1'>I am div#div1</div>"),t=e.virtual("<div id='div2'>I am div#div2</div>");e.editCssRules("#div1 { margin: 0.3rem; color: green; background-color: #EEE; }","#div2 { margin: 0.3rem; color: red; background-color: #EEE; }"),i.show({content:e.virtual("<div>").append(o,t),callback:()=>{e.removeCssRules("#div1","#div2");let s=[...e.node("#JQLStylesheet",document.documentElement).sheet.cssRules].filter(l=>l.cssText.startsWith("#div1")||l.cssText.startsWith("#div2"));i.show({content:`Rules removed, so we expect <code class="inline">rulesExist?.cssText</code>
                 ...
                 Is that so? ${u(s?.cssText)}`,closeAfter:5})}})},virtualEx:o=>{let t=e.node(".virtual");t&&t.remove();let s=r=>r.isVirtual?"Nope":"Yep",l=e.virtual('<div class="virtual" data-id="tmpEx">Hello</div>').append(e.virtual("<span> world!</span>").style({color:"red",fontWeight:"bold"}));i.show({content:e("<div>virtual element created. In DOM tree? </div>").append(` <b>${s(l)}.</b>`).append(" We'll add it to this chapter soon."),closeAfter:2.5,callback:()=>{l.toDOM(p(o)).append(`<b> In DOM tree? ${s(l)}</b>`)}}),setTimeout(()=>l.remove(),5e3)},toggleClassEx:o=>{if(!e(p(o)).find$(".divExClass").is.empty)return;let t=()=>{e.removeCssRule(".redEx"),e.removeCssRule("button#toggleColor, button#cleanup")};e.editCssRule(".redEx { color: red; }"),e.editCssRule("button#toggleColor, button#cleanup { margin: 0 5px; }");let s=e('<div class="divExClass redEx">Hello World!</div>',p(o));s.append(e.virtual('<button id="toggleColor">toggle</button>').on("click",(l,r)=>e(r[0].closest(".divExClass")).toggleClass("redEx"))),s.append(e.virtual('<button id="cleanup">remove</button>').on("click",(l,r)=>{r[0].closest(".divExClass").remove(),t()}))},replaceClassEx:o=>{let t=e('<div class="divExClass">Hello World!</div>',p(o)),s=()=>{t.remove(),e.removeCssRule(".redEx"),e.removeCssRule(".redExUl")};e.editCssRule(".redEx { color: red; }"),e.editCssRule(".redExUl { text-decoration: underline; }"),setTimeout(()=>{t.replaceClass("divExClass","redEx","redExUl"),setTimeout(s,2e3)},1500)},ISEx:o=>{let t={Object:{say:"hello"},Array:[1,2,3],RegExp:/[a-z]/gi,Null:null,Undefined:void 0,Zero:0,Symbol:Symbol("symbol1")},s=v=>e.IS(v,void 0,NaN,null),l=v=>e.IS(v),r=Object.keys(t).reduce((v,h)=>[...v,`<code class="inline">whatIs(someVars.${h})</code>: ${l(t[h])}`],[]);i.show({content:r.concat([`<code class="inline">$.IS(someVars.Object, Object)</code>: ${e.IS(t.Object,Object)}`,`<code class="inline">$.IS(someVars.Object, Array)</code>: ${e.IS(t.Object,Array)}`,`<code class="inline">$.IS(someVars.Object, String, Object, Array)</code>: ${e.IS(t.Object,String,Object,Array)}`,`<code class="inline">$.IS(someVars.Array, Array)</code>: ${e.IS(t.Array,Array)}`,`<code class="inline">$.IS(someVars.Array, Object)</code>: ${e.IS(t.Array,Object)}`,`<code class="inline">$.IS(someVars.RegExp, RegExp)</code>: ${e.IS(t.RegExp,RegExp)}`,`<code class="inline">$.IS(someVars.Null, undefined)</code>: ${e.IS(t.Null,void 0)}`,`<code class="inline">$.IS(someVars.Null, null)</code>: ${e.IS(t.Null,null)}`,`<code class="inline">$.IS(someVars.Zero, Boolean)</code>: ${e.IS(t.Zero,Boolean)}`,`<code class="inline">$.IS(someVars.Symbol, Symbol)</code>: ${e.IS(t.Symbol,Symbol)}`,`<code class="inline">isNothing(someVars.Undefined)</code>: ${s(t.Undefined)}`,`<code class="inline">isNothing(someVars.RegExp)</code>: ${s(t.RegExp)}`]).join("<br>")})},singleEx:o=>{e("<div data-id='tmpEx'>           <div class='test'>Hello world (1)</div>           <div class='test'>Hello world (2)</div>        </div>",o.target,e.insertPositions.AfterEnd),i.show({content:`<code class="inline">$("[data-id='tmpEx']").<b>single(".test")</b>.HTML.get(1,1)</code>
          <p>${e("[data-id='tmpEx']").single(".test").HTML.get(1,1)}</p>`,callback:f})},singleEx2:o=>{e("<div data-id='tmpEx'>           <div class='test'>Hello world (1)</div>           <div class='test'>Hello world (2)</div>        </div>",o.target,e.insertPositions.AfterEnd),i.show({content:`<code class="inline">$("[data-id='tmpEx']").<b>single()</b>.HTML.get(true, true)</code>
         <p>${e("[data-id='tmpEx']").single().HTML.get(!0,!0)}</p>`,callback:f})},singleEx3:o=>{e('<div data-id="tmpEx">           <div class="test">Hello world (1)</div>           <div class="test">Hello world (2)</div>           <div class="test">Hello world (3)</div>         </div>',o.target,e.insertPositions.AfterEnd),i.show({content:`<code class="inline">$(".test").<b>single(1)</b>.HTML.get(1, 1)</code>
         <p>${e(".test").single(1).HTML.get(1,1)}</p>`,callback:f})},htmlObjEx:o=>{let t=e.DIV({id:"initial"})[n],{HTML:s}=t;s.set("'nough said").data.set({iteration:"set"});let l=`<code class="inline">set</code>: ${s.get(!0,!0)}`;s.replace("HELLO").data.set({iteration:"replace"});let r=`<code class="inline">replace</code>: ${s.get(!0,!0)}`;s.append(e.span(" WORLD")[n]).data.set({iteration:"append"});let v=`<code class="inline">append</code>: ${s.get(!0,!0)}`;s.insert(e.B("The obligatory ... ")).data.set({iteration:"insert"});let h=`<code class="inline">insert</code>: ${s.get(!0,!0)}`,x=e.virtual(`<div class="description">
        ...
        (10 of ${h.length} rules, random sample)<ul>${[...h].slice(x,x+10).map(S=>`<li>${S}: ${h[S]}</li>`).join("")}</ul></div>`.replace(/\n+\s{2,}/g," ");i.show({content:e(e.DIV()).append(t,s,l,v,E),callback:()=>e.removeCssRules(`.${r}, .leftRedBorder`)})},attrEx:o=>{let t=p(o),s=e('<div data-id="tmpEx" class="initial">Hi, let me get some attributes</div>',t);s.attr({title:"Yes, I have a title now!",class:"volatile",data:{myTitle:"title as data"}});let[l,r,v,h,x]=[s.attr("data-id"),s.attr("title"),s.attr("class"),s.attr("data-my-title"),s.attr("onclick")];i.show({content:[`<code class="inline">someDiv.attr("data-id")</code>: ${l}`,`<code class="inline">someDiv.attr("data-my-title")</code>: ${h}`,`<code class="inline">someDiv.attr("title")</code>: ${r}`,`<code class="inline">someDiv.attr("class")</code>: ${v}`,`<code class="inline">someDiv.attr("onclick")</code>: ${x}`].join("<br>"),callback:s.remove})},computedStyleEx:o=>{e.editCssRule(".redEx {color: red; font-weight: bold}"),e('<p class="redEx">Hello!</p>',p(o)),i.show({content:`
         ...
         outerHTML <code class="inline">jqlElems.first()</code>: ${t.first()?.outerHTML.replace(/</g,"&lt;")}</div>`)})},first$Ex:o=>{let t=e(".docs").first$("#instance_first_D"),s=()=>{i.show({content:`<code class="inline">$(".docs h3").first$(17)</code> =&gt;<br>${e(".docs h3").first$(17).HTML.get(1,1)}`})};i.show({content:`<div><code class="inline">$(".docs").first$("#instance_first_D")</code> =&gt;<br>${t.HTML.get(1,1)}</div>`,callback:s})},first$Ex2:o=>{let t=e(".docs").first$(30001);i.show({content:`<div>non existing (should be <code class="inline">undefined</code>): ${t.outerHtml}</div>`})},dataEx:o=>{let t=e("<div>Hello World again</div>",p(o));e.editCssRule("[data-is-universe]:after {content: ' ... and the universe!'; color: red;}"),t.data.add({isUniverse:!0,something:"else","dashed-prop-given":1});let{all:s}=t.data;i.show({content:`<code class="inline">helloWrld.data.all</code> =&gt; ${JSON.stringify(t.data.all)}
          ...
          <br><code class="inline">myDATA.isUniverse</code> =&gt; ${s.isUniverse}`,callback:()=>{t.data.remove("isUniverse"),setTimeout(()=>{e.removeCssRule("[data-is-universe]:after"),t.remove()},3500)}})},eachEx:()=>{let o=e(".methodName"),t="rgb(165, 42, 42)",s=o.computedStyle("color");o.each(l=>e(l).style({color:s===t?"":t}))},clickNavGroup:(o,t)=>{let s=!e(t).hasClass("closed");e(".navGroup").each(l=>e(l).addClass("closed")),e.node(`#${t.dataset.group}_About`).scrollIntoView(),e(".selected").removeClass("selected"),e("ul.navGroupItems li:first-child div[data-navitem]",t).addClass("selected"),y(),!s&&t.classList.remove("closed")},clickNavItem:o=>(e(".navGroup").each(t=>e(t).addClass("closed")),e(o.target.closest(".navGroup")).removeClass("closed"),e.node(o.target.dataset.navitem).scrollIntoView(),e(".selected").removeClass("selected"),e(o.target).addClass("selected"),y()),jumpTo:o=>{let t=e(`[data-navitem='#${o}']`);t.trigger("click"),t[0].offsetTop>e.node("#navigation").offsetHeight&&t[0].scrollIntoView()},jump2Nav:o=>{let t=o.target.closest("[data-jumpgroup]")||o.target.closest("[data-jumpkey]");if(t){let s=t.dataset.jumpgroup,l=t.dataset.jumpkey;return e(s?`[data-group='${s}']`:`#${l}`).trigger("click")}}}}Prism.manual=!0;var H=location.host.startsWith("dev")||location.host.startsWith("localhost"),N=H?"../index.js":"../Bundle/jql.min.js",a=(await import(N)).default,P=new Map([["<","&lt;"],[">","&gt;"],["&",e=>`&amp;${e[1]}`],["linebreak",`
<br>`],["reducebreaks",`

`]]);a("#loader").remove();var W=e=>{let n=e.closest("pre");return n?a(n).addClass("language-javascript","line-numbers"):a(e).addClass("inline")},B=performance.now();document.title=H?`##DEV## ${document.title}`:document.title;H&&(a('link[rel="icon"]').replaceWith(a.LINK({href:"./devIco.png",rel:"icon"})),window.jql=a,window.IS=a.IS,window.popup=a.Popup);a.log("Start documenter...");var w=await fetch("./documentation.json").then(e=>e.json());a.log("Fetched documenter json...");var{clientHandling:_,allExampleActions:q}=I(a),G=["jql_About","static_About","instance_About","popup_About","debuglog_About"],F=G.reduce((e,n)=>[...e,{name:n,displayName:n.slice(0,n.indexOf("About")).toUpperCase()}],[]),L=e=>e.slice(e.indexOf("_")+1),U=({group:e,displayName:n})=>{let m=a(`<ul class="navGroup closed" data-group="${n.toLowerCase()}"/>`,a.node("#navigation"));return m.append(a(`<li class="grouped">${n}<ul class="navGroupItems"></ul></li>`)),Object.keys(w).filter(c=>c.startsWith(e.displayName.toLowerCase())).sort((c,d)=>c.localeCompare(d)).forEach(c=>{let d=c.replace(/([a-z])\$/gi,"$1_D"),u=/--DEPRECATED/.test(w[c]?.description);a(".navGroupItems",m[0]).append(a(`
            <li data-key="${d}">
            <div data-navitem="#${d}"${u?' class="deprecated"':""}>${L(c)}</div></li>`))}),n},A=a.node(".docs"),M=_;a.delegate("click",M);a.delegate("scroll",".container",M);var V=(e,n)=>{let m=e.trim().replace(/\n{3,}/g,P.get("reducebreaks"));return`<div class="exContainer"><h3 class="example">Example${n>0?` ${n+1}`:""}</h3><pre><code>${m}</code></pre></div>`};var J=e=>{let n=/(?<=<example>)(.|\n)*?(?=<\/example>)/gm,m=(e.match(n)||[]).map((d,u)=>V(d,u)),c=()=>{let d=m.shift();if(/##EXAMPLECODE/.test(d)){let u=d.slice(d.indexOf("@")+1).split("#")[0];d=d.replace(/##.+##/,q[u])+`<button class="exRunBttn" data-action="${u}">Try it</button>`}return d};return e.replace(/<example>(.|\n)*?<\/example>/g,c)};var D=e=>e.replace(/</g,"&lt;").replace(/&lt;code/g,"<code").replace(/&lt;\/code/g,"</code"),z=e=>Object.entries(e).map(([n,m])=>{let c=/_isobject/i.test(n)?"[Object&lt;string, any>]":n;return`<div class="param"><code>${D(c)}</code>: ${D(m)}</div>`});F.forEach(e=>{let n=U({group:e,displayName:e.displayName.slice(0,-1)});Object.entries(w).filter(([m,c])=>m.startsWith(`${e.displayName.toLowerCase()}`)).sort(([m],[c])=>m.localeCompare(c)).forEach(([m,c])=>{c.description=c.description.trim();let d=/--DEPRECATED/.test(c.description),u=L(m),g,i=[],b={instance:"[JQL instance].",popup:"[JQL.Popup].",debuglog:"[debugLog].",static:"[JQL]."};if(c.params?.length&&(g=`<div data-parameters><b>Parameters</b>${c.params.reduce((R,f)=>[...R,z(f)],[]).join("")}</div>`),/<example>/.test(c.description)&&(c.description=J(c.description)),u==="About")return a(`<div data-groupContainer="${n}" class="description">
          <h3 class="groupHeader" id="${e.name}">${n}</h3>${c.description.replace(/\n{3,}/g,`
`)}</div>`,A);a(`
        <div class="paragraph" data-for="${u.replace(/([a-z])\$/gi,"$1_D")}">
          <h3 class="methodName" id="${m.replace(/([a-z])\$/gi,"$1_D")}">
            <span class="group">${b[m.slice(0,m.indexOf("_"))]}</span
            ><span${d?' class="deprecated"':""}>${u}</span>
          </h3>
          ${g??""}
...
`)}</div>
        </div>`,A)})});k(a);a.log("Applied styling.");a("code").each(W);a.log("Documenter json parsed to DOM.");w=null;a(".docs").removeClass("loading");Prism.highlightAll();a.log("Code formatting done.");a.div({class:"container"},a.div({class:"docBrowser"}))[Symbol.jql];a(".docBrowser").append(a("#navigation"),a(".docs"));a.log("Wrapped into container.");a("#jql_About").html(' (<span class="jqlTitle"><b>JQ</b>uery<b>L</b>ike</span>)',!0);a('[data-group="jql"]').trigger("click");a.log("Navigation triggered.");a.log(`Documenter implementation took ${((performance.now()-B)/1e3).toFixed(3)} seconds`);var T=Q();if(T.load){let e=T.load.replace(/about/,"About"),n=a(`[data-navitem="#${e}"]`)||a(`[data-key="${e}"]`).closest(".navGroupItems");n&&(a(n).trigger("click"),a.Popup.show({content:a.b("loaded ",a.code({class:"inline"},T.load)),closeAfter:2}))}function Q(){return location.search.length>1?location.search.slice(1).split("&").reduce((m,c)=>{let[d,u]=c.split("=");return{...m,[d]:u}},{}):{}}
