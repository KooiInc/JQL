function f(e){e.editCssRules(":root{--method-head-color:blue;}","body{font:normal 12px/15px Verdana,Arial,sans-serif;overflow:hidden;}","#navigation{position:fixed;overflow-y:auto;top:1em;bottom:0;}","#navgation,.doc{scrollbar-width:none;-ms-overflow-style:none;}","#navigation::-webkit-scrollbar,.docs::-webkit-scrollbar{width:0;height:0;}",".docs{position:absolute;top:1em;bottom:0;left:7vw;padding-bottom:100rem;padding-left:1rem;max-width:40vw;overflow:auto;}",'.docs.loading:before{content:"Loading ...";font-size:3rem;font-weight:bold;color:red;display:block;margin-top:2rem;z-index:5;}',".param{margin-bottom:0.3rem;}",".navGroup{cursor:pointer;margin-left:-1.2rem;margin-block-start:0.5em;}","ul.navGroup.closed li.grouped{list-style:'\\25BC';}","ul.navGroup li.grouped{padding-left:0.2rem;list-style:'\\25b2';color:brown;}","ul.navGroup.closed li ul.navGroupItems{display:none;}","ul.navGroup li:not(.grouped){list-style:none;padding-left:0.2rem;margin-left:-2rem;}",".jqlTitle{color:green;}",".jqlTitle b{color:red;}",".selected{color:blue;font-weight:bolder;}","ul.navGroupItems li{color:#777;}","[data-key]{color:#777;}","[data-key]:hover{background-color:#eee;}","[data-groupcontainer]:not(first-child){padding:1.5rem 1rem 1rem;box-shadow:2px 2px 6px #999;border-radius:5px;max-width:96%;margin-top:3rem;}",".linkLike,.linkLike code{color:blue;cursor:pointer;display:inline-block;}",".linkLike:hover{text-decoration:underline;}",'.methodName{margin:1.5rem 0 0.5rem 0;color:var(--method-head-color);font-size:1.2rem;font-family:"Courier New",serif;cursor:pointer;background-color:#eee;padding:3px;border:1px solid #999;text-align:center;}',".methodName span.group{color:#777;}",".exRunBttn[disabled]{background-color:buttonface;border-width:1px;}",".groupHeader{min-width:100px;max-width:200px;text-align:center;border:1px solid green;padding:5px;border-radius:5px;background-color:#eee;margin:0 auto -3rem auto;position:relative;top:-3rem;}",".groupHeader:first-child{margin-top:1em;}",".groupHeader:not(:first-child){margin-top:2rem;}",".returnValue,.description:not([data-groupcontainer]){margin-top:0.6rem;}",".description div:not(.linkLike):not(.exContainer){margin:0.6rem 0 0.6rem 0;}",".description .template{display:none;}",".description ul{margin:0 0 auto -1.2rem;}",".description ul ul{margin:0 0 auto -1.2rem;}",".description ul ul li{list-style:'\\2714';margin-left:-0.7rem;vertical-align:top;}",".description ul li{list-style:'\\2705';margin-top:0.1rem;padding-left:0.2rem;vertical-align:top;}",".description ul li div{margin-top:0.1rem !important;margin-bottom:0.2rem !important;}",".example{margin-left:0.5rem;margin-bottom:-0.2rem;width:100%;}","[data-groupcontainer] .description div.exContainer,.paragraph .description div.exContainer{white-space:revert;width:96%;}",".exRunBttn{position:relative;display:block;margin:-1.2rem 0 1rem 1rem;}","code:not(.js){color:green;background-color:#EEE;display:inline-block;padding:1px;}","code b{color:red;}","img.gitLink{width:32px;height:32px;margin-right:4px;vertical-align:middle;}","@media (max-width:2200px){.docs{max-width:65vw;left:10vw;}}","@media (max-width:1440px){.docs{max-width:86vw;left:14vw;}"," [data-groupcontainer]:first-child{margin-top:1rem;}"," [data-groupcontainer],[data-groupcontainer]:not(first-child){max-width:92%;}"," h3.methodName{max-width:95%;}"," .description div:not(.linkLike):not(.exContainer){max-width:90%;}}","@media (max-width:1024px){.docs{left:16vw;max-width:80vw;}}","@media (max-width:800px){.docs{left:24vw;max-width:70vw;}}")}var k=D;function D(e){let a=L(e);return e.editCssRules('[data-id="tmpEx"], #tmpEx { white-space: normal; padding-top: 5px;}',".test { color: red; }"),function(l){if(l.type==="scroll")return c(l);let g=!l.target?.closest?.("[data-key]")&&l.target.closest(".navGroup"),u=l.target?.closest?.(".methodName"),h=l.target?.dataset?.action,E=l.target?.dataset?.navitem;if(g)return a.clickNavGroup(l,g);if(E)return a.clickNavItem(l);if(u)return a.jumpTo(u.id);if(h&&a[h])return a[h](l)};function c(i){let l=i.target.scrollTop,g=e.nodes(".paragraph, [data-groupcontainer]").find(u=>l-u.nextElementSibling.offsetTop<=-100);if(g){let u=e(`[data-navitem="#${g.querySelector("h3").id}"]`);u.hasClass("selected")||(e(".navGroup:not(.closed)").addClass("closed"),u.closest(".navGroup").removeClass("closed"),e(".selected").removeClass("selected"),u.addClass("selected"))}}}function L(e){let a=o=>o===void 0?"Yep \u{1F60E}":"Nope \u{1F621}",c=(o,t=0)=>([o,t]=[Math.floor(o),Math.ceil(t)],Math.floor([...crypto.getRandomValues(new Uint32Array(1))].shift()/4294967296*(o-t+1)+t)),i=e.virtual,l=e.Popup,g=e.node(".docs"),u=()=>g.scrollBy(0,-15),h=()=>{let o=i('<button id="modalCloseTest">Close me</button>').on("click",()=>l.removeModal()),t=()=>l.show({content:"Modal closed, you're ok, bye.",closeAfter:2}),s=i(e("[data-popup2]").html()).append(i("<p/>").append(o));l.show({content:s,modal:!0,callback:t,warnMessage:"There's only one escape here!"})},E=()=>{let o=i('<button id="modalCloseTest">Close me</button>').on("click",()=>l.removeModal()),t=()=>l.show({content:"Modal closed, you're ok, bye.",closeAfter:2}),s=i(e("[data-popup2]").html()).append(i("<p/>").append(o));l.show({content:s,modal:!0,callback:t,warnMessage:'"In other words: <i>you can only close this using the <b>button</b> ...</i>"'})},p=(...o)=>setTimeout(()=>{e('#tmpEx, [data-id="tmpEx"]').remove(),o.length&&e.removeCssRule(...o)},2500),x=(o=!1)=>o?e.removeCssRule("#tmpEx"):e.editCssRule("#tmpEx {color: green; font-weight: bold;}");return e.log("Documenter handling done."),{popupTimed:()=>l.show({content:e("[data-popup3]").html(),closeAfter:5}),popupModal:h,modalPopupShowDemo:E,popup:()=>l.show({content:i(e("[data-popup1]").outerHtml)}),popupShow:()=>l.show({content:i(e("[data-popup1]").outerHtml)}),addClassEx:o=>{e("#tmpEx").remove(),e.setStyle("#tmpEx.warnUser {color: red; font-weight: bold;}"),e.setStyle(".user:before {content: 'Hi user! ';}"),e('<div id="tmpEx">This is not very useful</div>',o.target.closest(".description")).addClass("warnUser","user"),p()},appendEx:o=>{e("#tmpEx").remove(),x(),e.editCssRule(".appended { color: red; cursor: pointer; }");let t=e.virtual('<div class="appended">I am an appended JQL instance ...</div>').on("click",()=>alert("HELLO!")),s=e('<div id="tmpEx">Hi there! Wait a sec ... </div>',o.target.closest(".description")).append(t,"Appended text","<div>Appended HTML string</div>",Object.assign(document.createElement("div"),{textContent:"Appended element"}));setTimeout(()=>l.show({content:t.html("Now I am appended to the popup element, you can still click me"),callback:()=>p(".appended","#tmpEx")}),1500)},prependEx:o=>{e("#tmpEx").remove(),x(),e.editCssRule(".appended { color: red; }"),e('<div id="tmpEx">... hi there!</div>',o.target.closest(".description")).prepend('<div class="appended">Hello and also ...</div>'),p(".appended")},afterMeEx:o=>{e.Popup.show({content:e.div("I am div 1").afterMe(e("<div>And I am div 2</div>"))})},beforeMeEx:o=>{e.Popup.show({content:e("<div>And I am div 2</div>").beforeMe(e.div("I am div 1"))})},andThenEx:o=>{let t=e.p("I am <p> the first"),s=e.p("I am <p> the second"),d="<code>ele1.andThen(ele2)</code>",r="<code>ele2.andThen(ele1, true)</code>";e.Popup.show({content:e(d).andThen(t).andThen(s),callback:()=>e.Popup.show({content:e(r).andThen(s.andThen(t,!0))})})},isEx:o=>{let t=e('<input id="disabledInput" disabled type="text" placeholder="I am not enabled">',o.target.closest(".description")),s=t.is,d=[`visible? ${s.visible}`,`disabled? ${s.disabled}`,`writable? ${s.writable}`];l.show({content:`<code>${e("#disabledInput").outerHtml.replace(/</g,"&lt;")}</code>
        ...
        </div>`,t);setTimeout(()=>{e('[data-id="tmpEx"] span',t).html("universe!"),setTimeout(()=>e('[data-id="tmpEx"] span',t).html(" And bye again",!0),1e3)},1e3),setTimeout(()=>e('[data-id="tmpEx]',t).remove(),5500)},outerHTMLEx:o=>{let t=i('<div data-id="tmpEx"><b>Hello</b> <span>World</span>!</div>',o.target.closest(".description"));l.show({content:`<code>exElem.outerHtml.replace(/&lt;/g, "&amp;lt;")</code> =&gt; ${t.outerHtml.replace(/</g,"&lt;")}
        ...
        <br><code>$(".redEx").computedStyle("font-weight")</code>: ${e(".redEx").computedStyle("font-weight")}`,callback:()=>{e.removeCssRule(".redEx"),e(".redEx").remove()}})},dimEx:o=>{let t=e('<p data-id="tmpEx">Hello, where am I at the moment?</p>',o.target.closest(".description")).style({color:"red",fontWeight:"bold"}),s=JSON.stringify(t.dimensions,null,2).replace(/[}{"]/g,"").trim().replace(/\n/g,"<br>");l.show({content:s,callback:()=>t.remove()})},findEx:()=>l.show({content:e(".docs").find("#instance_find")[0]?.outerHTML.replace(/</g,"&lt;")}),find_D_Ex:()=>l.show({content:e(".docs").find$("#instance_find_D").HTML.get(1,1)}),firstEx:o=>{let t=e("#navigation li[data-key]");l.show({content:e(`<div>
         ...
         outerHTML <code>jqlElems.first()</code>: ${t.first()?.outerHTML.replace(/</g,"&lt;")}</div>`)})},first$Ex:o=>{let t=e(".docs").first$("#instance_first_D"),s=()=>{l.show({content:`<code>$(\`.docs h3\`).first$(17)</code> =&gt;<br>${e(".docs h3").first$(17).HTML.get(1,1)}`})};l.show({content:`<div><code>$(\`.docs\`).first$(\`#instance_first_D\`)</code> =&gt;<br>${t.HTML.get(1,1)}</div>`,callback:s})},first$Ex2:o=>{let t=e(".docs").first$(30001);l.show({content:`<div>non existing (should be <code>undefined</code>): ${t.outerHtml}</div>`})},dataEx:o=>{let t=e("<div>Hello World again</div>",o.target.closest(".description"));e.editCssRule("[data-is-universe]:after {content: ' ... and the universe!'; color: red;}"),t.data.add({isUniverse:!0,something:"else","dashed-prop-given":1}),l.show({content:`<code>helloWrld.data.all</code> =&gt; ${JSON.stringify(t.data.all)}
          ...
          <br><code>helloWrld.data.get("nonexisting", "no sir, I'm not here")</code> =&gt; ${t.data.get("nonexisting","no sir, I'm not here")}`,callback:()=>{t.data.remove("isUniverse"),setTimeout(()=>{e.removeCssRule("[data-is-universe]:after"),t.remove()},3500)}})},eachEx:()=>{let o=e(".methodName"),t="rgb(165, 42, 42)",s=o.computedStyle("color");o.each(d=>e(d).style({color:s===t?"":t}))},clickNavGroup:(o,t)=>{let s=!e(t).hasClass("closed");e(".navGroup").each(d=>e(d).addClass("closed")),e.node(`#${t.dataset.group}_About`).scrollIntoView(),e(".selected").removeClass("selected"),e("ul.navGroupItems li:first-child div[data-navitem]",t).addClass("selected"),u(),!s&&t.classList.remove("closed")},clickNavItem:o=>(e(".navGroup").each(t=>e(t).addClass("closed")),e(o.target.closest(".navGroup")).removeClass("closed"),e.node(o.target.dataset.navitem).scrollIntoView(),e(".selected").removeClass("selected"),e(o.target).addClass("selected"),u()),jumpTo:o=>{let t=e(`[data-navitem='#${o}']`);t.trigger("click"),t[0].offsetTop>e.node("#navigation").offsetHeight&&t[0].scrollIntoView()},jump2Nav:o=>{let t=o.target.dataset.jumpgroup,s=o.target.dataset.jumpkey;e(t?`[data-group='${t}']`:`[data-navitem='#${s}']`).trigger("click")}}}var w=location.host.startsWith("dev"),j=w?"../index.js":"../../Bundle/jql.min.js",n=(await import(j)).default;n("#loader").remove();var A=performance.now();document.title=w?`##DEV## ${document.title}`:document.title;w&&(n('link[rel="icon"]').replaceWith(n.LINK.prop({href:"./devIco.png",rel:"icon"})),window.jql=n,window.IS=n.IS,window.popup=n.Popup);n.log("Start documenter...");var M=(e,a=0)=>([e,a]=[Math.floor(e),Math.ceil(a)],Math.floor(crypto.getRandomValues(new Uint32Array(1))[0]/2**32*(e-a+1)+a)),y=await fetch(`./documentation.json?v=${M(1e4,1e3)}`).then(e=>e.json());n.log("Fetched documenter json...");f(n);n.log("Applied styling...");var N=["jql_About","static_About","instance_About","popup_About","debuglog_About"],O=N.reduce((e,a)=>[...e,{name:a,displayName:a.slice(0,a.indexOf("About")).toUpperCase()}],[]),R=e=>e.slice(e.indexOf("_")+1),W=({group:e,displayName:a})=>{let c=n(`<ul class="navGroup closed" data-group="${a.toLowerCase()}"/>`,n.node("#navigation"));return c.append(n(`<li class="grouped">${a}<ul class="navGroupItems"></ul></li>`)),Object.keys(y).filter(i=>i.startsWith(e.displayName.toLowerCase())).sort((i,l)=>i.localeCompare(l)).forEach(i=>{let l=i.replace(/([a-z])\$/gi,"$1_D");n(".navGroupItems",c[0]).append(n(`<li data-key="${l}"><div data-navitem="#${l}">${R(i)}</div></li>`))}),a},T=n.node(".docs"),S=k(n);n.delegate("click",S);n.delegate("scroll",".docs",S);var _=(e,a)=>`<div class="exContainer"><h3 class="example">Example${a>0?` ${a+1}`:""}</h3><pre><code class="js language-javascript line-numbers">${e.trim().replace(/</g,"&lt;").replace(/>/g,"&gt;")}</code></pre></div>`,P=e=>{let a=/(?<=<example>)(.|\n)*?(?=<\/example>)/gm,c=(e.match(a)||[]).map((i,l)=>_(i,l));return e.replace(/<example>(.|\n)*?<\/example>/g,()=>c.shift())};var H=e=>e.replace(/</g,"&lt;").replace(/&lt;code/g,"<code").replace(/&lt;\/code/g,"</code"),G=e=>Object.entries(e).map(([a,c])=>{let i=/_isobject/i.test(a)?"[Object&lt;string, any>]":a;return`<div class="param"><code>${H(i)}</code>: ${H(c)}</div>`});O.forEach(e=>{let a=W({group:e,displayName:e.displayName.slice(0,-1)});Object.entries(y).filter(([c,i])=>c.startsWith(`${e.displayName.toLowerCase()}`)).sort(([c],[i])=>c.localeCompare(i)).forEach(([c,i])=>{i.description=i.description.trim();let l=R(c),g="<span/>",u=[],h={instance:"[JQL instance].",popup:"[JQL.Popup].",debuglog:"[debugLog].",static:"[JQL]."};if(i.params?.length&&(g=`<div><b>Parameters</b>${i.params.reduce((p,x)=>[...p,G(x)],[]).join("")}</div>`),/<example>/.test(i.description)&&(i.description=P(i.description)),l==="About")return n(`<div data-groupContainer="${a}" class="description">
          <h3 class="groupHeader" id="${e.name}">${a}</h3>${i.description.replace(/\n{3,}/g,`
`)}</div>`,T);n(`
        <div class="paragraph">
          <h3 class="methodName" id="${c.replace(/([a-z])\$/gi,"$1_D")}"><span class="group">${h[c.slice(0,c.indexOf("_"))]}</span>${l}</h3>
          ${g}
          <div class="returnValue"><b>Returns</b>: ${i.returnValue}</div>
          <div class="description">${i.description.replace(/\n{2,}/g,`
`)}</div>
        </div>`,T)})});n.log("Documenter json parsed to DOM.");y=null;n(".docs").removeClass("loading");console.log("wtf",Prism);n("code.language-javascript").each(e=>Prism.highlightElement(e));n.log("Code formatting done.");n("#jql_About").html(' (<span class="jqlTitle"><b>JQ</b>uery<b>L</b>ike</span>)',!0);n('[data-group="jql"]').trigger("click");n.log("Navigation triggered.");n.log(`Documenter implementation took ${Math.round(performance.now()-A)}Ms`);
